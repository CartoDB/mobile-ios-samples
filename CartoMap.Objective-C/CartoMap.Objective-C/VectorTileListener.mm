//
//  VectorTileListener.m
//  AdvancedMap.Objective-C
//
//  Created by Aare Undo on 25/10/16.
//  Copyright © 2016 Nutiteq. All rights reserved.
//

#import "VectorTileListener.h"

@implementation VectorTileListener
...
- (BOOL)onVectorTileClicked:(NTVectorTileClickInfo *)clickInfo
{
    ...
    NSString* message = [[feature getProperties] description];
    
    clickPopup = [[NTBalloonPopup alloc] initWithPos:[clickInfo getClickPos] style:[styleBuilder buildStyle] title:@"" desc:message];
