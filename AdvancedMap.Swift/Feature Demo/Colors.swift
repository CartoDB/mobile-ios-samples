...
class Colors {
    ...
    public static var transparentPredictionBlue: UIColor = fromRgba(red: 23, green: 133, blue: 251, alpha: 170)
    
    public static var softOrange: UIColor = fromRgba(red: 255, green: 126, blue: 71, alpha: 255)
